...
A dona de um PETSHOP quer criar um programa para calcular a idade dos cachorros de seus clientes em "anos de cachorro". 
Como os pets envelhecem de maneira diferente dos humanos - cada ano humano corresponde a 7 do Cachorro.
...
idadepet =int(input("Digite a idade do cachorro: "))
petidade = idadepet * 7

print(f"A idade do seu pet é {petidade}")
